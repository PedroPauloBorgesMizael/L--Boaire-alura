...
const Figure = styled.figure`
    width: ${props => props.$expandida ? '50%' : '460px'};
...
const Imagens = ({ foto, expandida = false, aoZoomSolicitado, aoAlternarFavorito }) => {
    ...
    const iconeFavorito = foto.favorita ? "/imagens/icones/favorite.png" : "/imagens/icones/favorite_outline.png";
        ...
        <figcaption>
            ...
            <Rodape>
                ...
                {!expandida && <BotaoIcone aria-hidden={expandida} onClick={() => aoZoomSolicitado(foto)}>
                    <img src="/imagens/icones/open_in_full.png" alt="Icone de expandir" />
                </BotaoIcone>}
            </Rodape>
        </figcaption>
    </Figure>)
